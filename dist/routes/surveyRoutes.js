...
const checkSurveyEditable_1 = require("../middleware/checkSurveyEditable");
...
router.put("/:id", authMiddleware_1.authenticateJWT, checkSurveyEditable_1.checkSurveyEditable, (0, validateMiddleware_1.validate)(surveyValidation_1.updateSurveySchema), controller.update);
