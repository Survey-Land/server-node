...
router.post('/', authMiddleware_1.authenticateJWT, uploadFiles_1.default.upload.fields([{ name: "file", maxCount: 10 }]), uploadFiles_1.default.uploadFilesToS3("moajem"), (0, validateMiddleware_1.validate)(surveyValidation_1.createSurveySchema), controller.create);
router.put('/:id', authMiddleware_1.authenticateJWT, (0, validateMiddleware_1.validate)(surveyValidation_1.updateSurveySchema), controller.update);
