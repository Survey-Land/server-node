...
router.put("/:surveyId/:qid", authenticateJWT, validate(updateQuestionSchema), controller.updateQuestion);
router.delete("/:surveyId/:qid", authenticateJWT, controller.deleteQuestion);
