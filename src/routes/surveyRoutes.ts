...
router.post('/', authenticateJWT,uploadFiles.upload.fields([{ name: "file", maxCount: 10 }]),
uploadFiles.uploadFilesToS3("moajem"),validate(createSurveySchema), controller.create);
